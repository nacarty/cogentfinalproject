...
public class BooksController {
	...
	private List <Books> getAllBooks(){
		return cartyBService.getAllBooks();
	}
	...
	public  void saveBooksOneByOne(@RequestBody Collection<Books> books) {
		...
		L.forEach((book)->cartyBService.saveOrUpdate(book));		
	}
	...
	public  void saveOneOrMoreBooks(@RequestBody String jsonString) {
		...
		try {
			...
			cartyBService.saveOrUpdate(book);
			...
			try {
				...
				cartyBService.saveAll(bookList);
